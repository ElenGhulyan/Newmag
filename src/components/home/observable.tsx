        ...
        <>
            <section className='bg-[#F1F6F9] '>
                <div className='content py-[100px]'>
                    ...
                    {/*    <h2 className='text-black text-3xl not-italic font-semibold'>Ուշադրության արժանի </h2>*/}
                    {/*    <p className='text-orange-600 text-lg not-italic font-medium leading-6'><a href="" className='flex gap-[10px] items-center'>Բոլոր ապրանքները*/}
