        ...
        <section className='mt-[100px] mb-[100px]'>
            <div className='content '>
                <div className='flex justify-between '>
                    <h2 className='text-[#000] text-3xl not-italic font-semibold'>Կարծիքներ </h2>
                    <p className='text-[ #F34802] text-lg not-italic font-medium leading-6'><a href="" className='flex gap-[10px] items-center'>Բոլոր կարծիքները
