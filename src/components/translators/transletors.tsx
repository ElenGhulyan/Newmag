...
import TranslatorItem from "../productsItem/translatorItem";
        ...
        <>
            <div className='content'>
                ...
                <div className='flex gap-[10px] items-center mb-[47px]'>
                    ...
                    <span className='font_semibold text-lg text-[#F34802]'>Թարգմանիչներ</span>
                </div>

                <h1 className='text-3xl font_semibold'>Թարգմանիչներ</h1>
                <div className='w-full grid grid-cols-6 gap-[60px] mt-[65px]'>
                    {
                        items.map((item) => {
                            return (
                               <TranslatorItem item={item} />
                            )
                        })
                    }
                ...
                <Pagination data={TranslatorsData} setActiveItems={(items:any)=>{
                    SetItems(items)}} />
            </div>
        </>
    )
