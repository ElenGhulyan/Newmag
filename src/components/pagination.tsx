...
const Pagination = ({ BooksData }: any) => {
            ...
            <div className="pagination flex gap-[45px] justify-end mt-[40px]">
                ...
                <button onClick={goToNextPage}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
                        <path d="M6.61598 3.04513C6.38164 3.28021 6.25 3.59901 6.25 3.93141C6.25 4.26381 6.38164 4.58261 6.61598 4.81769L12.8035 11.0229L6.61598 17.2281C6.38829 17.4645 6.26229 17.7812 6.26514 18.1099C6.26799 18.4385 6.39945 18.753 6.63121 18.9854C6.86297 19.2178 7.17649 19.3496 7.50423 19.3525C7.83198 19.3554 8.14773 19.229 8.38348 19.0007L15.4547 11.9092C15.6891 11.6741 15.8207 11.3553 15.8207 11.0229C15.8207 10.6905 15.6891 10.3717 15.4547 10.1366L8.38348 3.04513C8.14907 2.81012 7.83119 2.6781 7.49973 2.6781C7.16828 2.6781 6.85039 2.81012 6.61598 3.04513Z" fill="#F34802"/>
                    </svg>
                </button>
            </div>
        </div>
