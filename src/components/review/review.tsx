        ...
        <>
            <div className='content'>
                ...
                <div className='flex gap-[10px] items-center mb-[47px]'>
                    ...
                    <span className='font_semibold text-lg text-[#F34802]'>Կարծիքներ</span>
                </div>

                <h1 className='text-3xl font_semibold'>Կարծիքներ</h1>
                <div className='w-full grid grid-cols-2 gap-[60px] mt-[65px]'>
                    {
                        items.map((item) => {
                            return (
